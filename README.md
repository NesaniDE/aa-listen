...
Lokale Top-10 Plattform für Aalen. Nach dem Vorbild von [GD Listen](https://github.com/NesaniDE/gd-listen) (Schwäbisch Gmünd).
...
| Datei | Stand |
|---|---|
| `src/data/categories` | 10 Kategorien, 68 Unterkategorien für Aalen |
| `src/data/companies` | **151 Unternehmensprofile** mit Adresse, teils Telefon und Website |
| `src/data/lists` | **15 vollständige Top-10-Listen** |
| `src/data/blog` | leer |
...
Vercel, Domain `www.aa-listen.de`. Der Cron in `vercel.json` pingt täglich um 03:00 `/api/indexnow`.
