...
export const metadata = createPageMetadata({
  title: 'Kontakt',
  description:
    'AA Listen ist redaktionelle Wissensbank für Aalen. Korrekturen, Entfernungsanfragen, Hinweise und Eintragsanfragen bitte über die Nesani UG.',
  path: '/kontakt',
...
const contactItems = [
  ...
  { label: 'Standort', value: 'Aalen, Baden-Württemberg' },
]
...
const reasons = [
  ...
  },
  {
    ...
    desc: 'Du kennst eine Adresse in Aalen, die in einer Top-10-Liste fehlen sollte? Sag Bescheid.',
  },
  {
  ...
  },
  {
    ...
    desc: `Anfragen rund um AA Listen oder den Betreiber Nesani gehen ebenfalls an ${contactEmail}.`,
  },
]
  ...
  return (
    <div>
      <PageHero
        badge="Kontakt"
        title="Schreib uns"
        subtitle="AA Listen ist eine redaktionelle Wissensbank — für Korrekturen, Entfernungsanfragen und Hinweise nutzen wir den direkten Weg per E-Mail."
      />
