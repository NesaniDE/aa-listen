...
export const metadata = createPageMetadata({
  title: 'Impressum',
  description: 'Impressum und rechtliche Pflichtangaben für AA Listen — betrieben von der Nesani UG (haftungsbeschränkt), HRB 751868, aus Schwäbisch Gmünd.',
  path: '/impressum',
})
...
const sections = [
  ...
  },
  {
    ...
    content: [
      'Die auf AA Listen veröffentlichten Listen, Reihenfolgen und Unternehmensbeschreibungen stellen redaktionelle Einschätzungen dar.',
