...
export const metadata = createPageMetadata({
  title: 'Blog & Ratgeber',
  description:
    'Tipps, Hintergründe und lokale Empfehlungen für Aalen — redaktionell eingeordnet für Gastro, Gesundheit, Freizeit, Handel und Dienstleister.',
  path: '/blog',
  ...
  return (
    <div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            collectionPageJsonLd(
              ...
              'Lokale Ratgeber, Hintergründe und thematische Einordnungen von AA Listen für Aalen.',
              '/blog',
            ),
          ),
        }}
      ...
      <PageHero
        badge="Ratgeber"
        title="Blog & Ratgeber"
        subtitle="Tipps, Hintergründe und redaktionelle Einordnungen zu lokalen Themen aus Aalen."
      />
