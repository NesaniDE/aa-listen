...
export const metadata = createPageMetadata({
  title: 'Kategorien',
  description:
    'Alle Kategorien von AA Listen — Gastro, Freizeit, Beauty, Gesundheit, Handwerk, Dienstleister und mehr. Redaktionell eingeordnet für Aalen.',
  path: '/kategorie',
  ...
  return (
    <div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            collectionPageJsonLd(
              ...
              'Alle Hauptkategorien von AA Listen mit thematischen Einstiegen für Aalen.',
              '/kategorie',
            ),
          ),
        }}
      ...
      <PageHero
        ...
        subtitle="Von Gastro bis Handwerk — entdecke lokale Anbieter in Aalen, redaktionell eingeordnet in thematischen Listen."
      />
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        ...
        <section style={{ maxWidth: '820px', marginBottom: '2.5rem' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.96rem', lineHeight: 1.75 }}>
            Die Kategorien auf AA Listen sind keine leeren Container, sondern die strukturelle Basis für lokale
            Themencluster. Von hier aus führen Pfade in Unterkategorien, Top-10-Listen, Unternehmensprofile und
            begleitende Blogartikel für Aalen.
          </p>
        </section>
        <div
