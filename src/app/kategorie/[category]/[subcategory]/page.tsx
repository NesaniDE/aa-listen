...
export async function generateMetadata({
  ...
  const description = published
    ...
    : `${subcategory.label} in ${siteConfig.city} wird auf AA Listen aktuell als Themenfeld aufgebaut. Diese Seite verlinkt auf bereits veröffentlichte Inhalte und bleibt bis zum Ausbau bewusst schlank.`
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            >
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.92rem', lineHeight: 1.7, marginBottom: '0.75rem' }}>
                Für {subcategory.label} existiert auf AA Listen bereits die thematische Struktur, aber noch keine
