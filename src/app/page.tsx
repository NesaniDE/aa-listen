...
export const metadata = createPageMetadata({
  ...
  description:
    'AA Listen bündelt redaktionelle Top-10-Listen und Unternehmensprofile für Aalen. Entdecke Restaurants, Cafés, Handwerk, Dienstleister und mehr.',
  path: '/',
  keywords: ['AA Listen', siteConfig.city, 'Top-10 Listen', 'lokale Empfehlungen', ...siteConfig.keywords],
})
  ...
  const principles = [
    {
      ...
      desc: 'Keine deutschlandweiten Trefferlisten. Nur Aalen, dafür mit echtem Stadtbezug.',
    },
    {
  ...
  return (
    <div>
      <section style={{ padding: '7rem 0 5rem' }}>
        <div className="section-container">
          <div style={{ maxWidth: '860px' }}>
            ...
            >
              AA Listen bündelt redaktionelle Top-10-Listen, lokale Unternehmensprofile und thematische Ratgeber für
          ...
          >
            ...
            >
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.75 }}>
                ...
                Unternehmensprofile und Blogartikel. Genau diese interne Verlinkung macht AA Listen für Nutzer und
      ...
      <section style={{ padding: '5rem 0' }}>
        <div className="section-container">
          <SectionHeader eyebrow="Kategorien" title="Die wichtigsten Themenfelder in AA" link={{ href: '/kategorie', label: 'Alle Kategorien' }} />
        ...
        <div className="section-container">
          <div style={{ marginBottom: '3rem', maxWidth: '760px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.98rem', lineHeight: 1.7 }}>
              ...
              Themen. Genau dieses Muster bildet AA Listen Schritt für Schritt aus.
            </p>
          </div>
          ...
          >
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '1rem', lineHeight: 1.6, marginBottom: '1.75rem' }}>
                Unternehmen profitieren auf AA Listen nicht nur von einer Profilseite, sondern von thematischer
