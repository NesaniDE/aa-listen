...
export const metadata = createPageMetadata({
  title: 'Über AA Listen',
  description:
    'AA Listen ist eine redaktionelle Listen-Plattform exklusiv für Aalen — betrieben von der Nesani UG mit dem Ziel klarer lokaler Orientierung.',
  path: '/ueber-aa-listen',
  keywords: ['Über AA Listen', siteConfig.city, ...siteConfig.keywords],
})
...
export default function UeberGdListenPage() {
  ...
  const blocks = [
    {
      title: 'Die Idee',
      text: 'AA Listen soll zeigen, dass lokale Empfehlungen nicht wie ein beliebiges Branchenverzeichnis aussehen müssen. Statt überladener Trefferlisten entsteht eine kuratierte Plattform mit festen Kategorien, klaren Top-10-Seiten und sauber strukturierten Unternehmensprofilen.',
    },
    {
      title: 'Der Fokus',
      text: 'Der Startpunkt ist bewusst eng gesetzt: nur Aalen. Genau diese Konzentration macht die Plattform stark, weil Inhalte, Unternehmen und Nutzerkontext nicht verwässern.',
    },
    {
      title: 'Die Einordnung',
      text: 'AA Listen veröffentlicht redaktionelle Einschätzungen und keine objektiven Qualitätsurteile. Listen und Reihenfolgen sollen Orientierung geben, nicht eine endgültige oder vollständige Wahrheit über lokale Anbieter behaupten.',
    },
    {
  ...
  return (
    <div>
      <PageHero
        badge="Über uns"
        title="Was ist AA Listen?"
        subtitle="Eine lokale redaktionelle Listen-Plattform nur für Aalen — klar strukturiert, thematisch sortiert und auf Orientierung statt Absolutheit ausgelegt."
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.65 }}>
              ...
              entwickelt und betrieben — einer Digitalagentur aus Aalen für Websites,
        ...
        <CTASection
          title="Dabei sein?"
          subtitle="Trage dein Unternehmen ein oder nimm Kontakt auf, wenn du AA Listen gemeinsam weiterentwickeln willst."
