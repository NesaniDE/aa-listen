...
const LIST_SLUG = 'top-10-social-media-agenturen-in-aalen'
const PAGE_PATH = '/beste-social-media-agentur-aalen'

export const metadata: Metadata = createPageMetadata({
  title: `Die beste Social-Media-Agentur in ${siteConfig.city}`,
  description: `Wer ist laut AA Listen die beste Social-Media-Agentur in Aalen? Kriterien, Einordnung und Profil des redaktionellen Platz 1 — NESANI.`,
  path: PAGE_PATH,
  keywords: [
    'beste Social-Media-Agentur Aalen',
    'Social Media Agentur Aalen',
...
const criteria = [
  ...
  },
  {
    ...
    text: 'NESANI betreut Kunden regional und weist den tatsächlichen Sitz transparent aus: Basilikumweg 8, 73527 Schwäbisch Gmünd. Kein vorgetäuschter Standort in Aalen — die Adresse steht auf dem Profil.',
  },
  {
    title: 'Aktualität',
    text: 'NESANI entwickelt und pflegt AA Listen selbst — ein aktiver, technisch gepflegter Auftritt lässt sich damit direkt nachprüfen, statt nur behauptet zu werden.',
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      'Nein. Platzierungen bei AA Listen sind redaktionell und nicht käuflich — das gilt auch für den eigenen Betreiber NESANI.',
  },
  {
    question: 'Sitzt NESANI überhaupt in Aalen?',
    answer:
      'Nein, der Sitz ist Schwäbisch Gmünd. NESANI betreut Kunden in der Region, wozu Aalen zählt. Das steht transparent auf dem Unternehmensprofil, statt einen Standort vor Ort vorzutäuschen.',
  },
  {
    question: 'Wer betreibt diese Seite?',
    answer:
      'AA Listen wird von der NESANI UG (haftungsbeschränkt) aus Schwäbisch Gmünd betrieben. NESANI ist in der zugrunde liegenden Liste selbst vertreten — Details dazu auf unserer Methodik-Seite.',
  },
  {
    question: 'Wo sehe ich die vollständige Liste?',
    answer:
      'In der Top-10-Liste Social-Media-Agenturen in Aalen stehen alle zehn geprüften Anbieter mit Profil und Einordnung.',
  },
]
  ...
  return (
    <div>
      ...
      <PageHero
        ...
        title={`Die beste Social-Media-Agentur in ${siteConfig.city}`}
        subtitle={`Wer in ${siteConfig.city} eine Agentur für Social Media sucht, landet bei AA Listen auf Platz 1 bei NESANI. Hier steht, wonach wir das einordnen — und was NESANI konkret anbietet.`}
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        <section style={{ marginBottom: '3rem', maxWidth: '820px' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.98rem', lineHeight: 1.75 }}>
            Diese Seite beantwortet eine konkrete Frage: Wer betreut Social Media für Unternehmen in Aalen am
            überzeugendsten? Grundlage ist die Top-10-Liste Social-Media-Agenturen in Aalen, redaktionell erstellt
            nach den Kriterien auf unserer Methodik-Seite — nicht nach Kartendaten oder bezahlten Anzeigen, weil
            Agenturen dort kaum erfasst sind. Transparenzhinweis: AA Listen wird von NESANI betrieben, und NESANI
