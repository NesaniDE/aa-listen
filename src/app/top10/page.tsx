...
export const metadata = createPageMetadata({
  ...
  description:
    'Übersicht aller redaktionellen Top-10-Listen für Aalen — Restaurants, Cafés, Fitnessstudios, Friseure, Zahnärzte und weitere lokale Themen.',
  path: '/top10',
  ...
  return (
    <div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            collectionPageJsonLd(
              ...
              'Alle veröffentlichten redaktionellen Top-10-Listen von AA Listen für Aalen.',
              '/top10',
            ),
          ),
        }}
      ...
      <PageHero
        ...
        title="Alle aktuellen AA-Listen"
        subtitle={`Aktuell ${top10Lists.length} veröffentlichte redaktionelle Listen für Aalen. Die Reihenfolgen spiegeln unsere Einschätzung wider und die Plattform wächst Kategorie für Kategorie.`}
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        ...
        <section style={{ maxWidth: '860px', marginBottom: '2.5rem' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.96rem', lineHeight: 1.75 }}>
            Diese Übersicht bündelt alle bereits veröffentlichten Rankings von AA Listen. Dadurch lassen sich Themen
            direkt vergleichen, einzelne Suchintentionen schneller ansteuern und neue Cluster innerhalb von
            Aalen besser entdecken.
          </p>
        </section>
