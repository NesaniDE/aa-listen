...
export const metadata = createPageMetadata({
  ...
  description:
    'Werde Teil von AA Listen — redaktionelle Sichtbarkeit für lokale Unternehmen in Aalen. Informationen zu Paketen, Ablauf und häufigen Fragen.',
...
const faqItems = [
  {
    ...
    answer:
      'Grundsätzlich redaktionell: AA Listen beobachtet lokale Kategorien und baut daraus Listen-Seiten. Unternehmen können zusätzlich anfragen, ob ihr Profil ergänzt, korrigiert oder überarbeitet werden soll.',
  },
  {
  ...
  {
    question: 'Ist AA Listen nur für Aalen?',
    answer:
...
const benefits = [
  { title: 'Lokaler Fokus', desc: 'AA Listen konzentriert sich nicht auf ganz Deutschland, sondern auf Aalen.' },
  ...
  return (
    <div>
      <PageHero
        ...
        title="Werde Teil von AA Listen"
        subtitle="Die Plattform ist auf Aalen fokussiert. Listen und Reihenfolgen sind redaktionelle Einschätzungen und keine objektiven Qualitätsurteile."
      />
