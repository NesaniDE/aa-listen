...
export const metadata = createPageMetadata({
  ...
  description: 'Datenschutzerklärung für AA Listen — transparente Informationen zur Datenverarbeitung, zu eingesetzten Diensten und zu deinen Rechten nach DSGVO und BDSG.',
  path: '/datenschutz',
})
...
const sections = [
  ...
  },
  {
    ...
    text:
      'Unternehmenslogos werden aktuell aus öffentlich erreichbaren Favicon-Quellen abgeleitet und über die Website ausgeliefert. Außerdem enthält AA Listen externe Links zu Websites Dritter. Beim bewussten Anklicken solcher Links gelten die Datenschutzbestimmungen der jeweiligen Anbieter.',
  },
  {
