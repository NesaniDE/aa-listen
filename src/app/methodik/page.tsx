...
export const metadata = createPageMetadata({
  title: 'Methodik',
  description:
    'Wie AA Listen redaktionelle Top-10-Listen für Aalen einordnet — Kriterien, Prozess und transparente Hinweise ohne Anspruch auf Vollständigkeit.',
  path: '/methodik',
...
const criteria = [
  ...
  {
    title: 'Lokaler Bezug',
    desc: 'AA Listen fokussiert sich auf Aalen. Relevanz für die Stadt ist ein zentrales Kriterium.',
  },
  {
    title: 'Aktualität',
...
const faqItems = [
  {
    ...
    answer:
      'Nein. Die Listen sind redaktionelle Einschätzungen von AA Listen und kein amtliches, vollständiges oder allgemeingültiges Ranking. Sie sollen die lokale Suche vereinfachen, nicht eine endgültige Wahrheit behaupten.',
  },
  {
    question: 'Steht der Betreiber selbst in den Listen?',
    answer:
      'Ja. AA Listen wird von der NESANI UG (haftungsbeschränkt) aus Schwäbisch Gmünd betrieben, und NESANI ist in einzelnen Dienstleisterlisten selbst aufgeführt. Wir weisen das im Intro der betroffenen Listen und auf dem Unternehmensprofil aus, damit die Platzierung einordbar bleibt.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Ja. Langfristig ist AA Listen genau dafür gedacht: Unternehmen können ihr Profil mit Bildern, Leistungen, Texten und Aktualisierungen verbessern.',
  },
]
  ...
  return (
    <div>
      <PageHero
        ...
        subtitle="Wie wir redaktionelle Listen für Aalen strukturieren — transparent, lokal und ohne Anspruch auf objektive Allgemeingültigkeit."
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        <section style={{ maxWidth: '720px', marginBottom: '5rem' }}>
          <p style={{ color: 'var(--text)', lineHeight: 1.75, fontSize: '1.0625rem' }}>
            AA Listen versteht sich nicht als objektiver Richter über lokale Qualität, sondern als strukturierte
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.7 }}>
            ...
            außerhalb der Rangfolge; sie verändert keine Platzierung. Der Betreiber in eigener Sache: AA Listen wird von der NESANI UG (haftungsbeschränkt) betrieben. NESANI ist in einzelnen Dienstleisterlisten selbst aufgeführt; das ist im Intro der jeweiligen Liste ausgewiesen.
          </p>
        </section>
